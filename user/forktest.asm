...
forktest(void)
{
  ...
  3e:	3fe50513          	add	a0,a0,1022 # 438 <symlink+0xe>
  ...
  68:	3e450513          	add	a0,a0,996 # 448 <symlink+0x1e>
  ...
  b8:	3e450513          	add	a0,a0,996 # 498 <symlink+0x6e>
  ...
  d4:	39850513          	add	a0,a0,920 # 468 <symlink+0x3e>
  ...
  ee:	39650513          	add	a0,a0,918 # 480 <symlink+0x56>
